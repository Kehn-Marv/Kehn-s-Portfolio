...
Built as a neo-brutalist, motion-heavy Next.js site with an interactive Three.js / R3F scene.
...
```
site/           → Next.js app (run everything from here)
docs/           → design notes + README screenshots
assets_gen/     → generated art assets
design_refs/    → design token / reference exports
```
...
Private source shared for learning / inspiration. Ask before reusing assets or shipping a close copy commercially.
